...
| ---------------------------------------------------- | -------------------------------------------- |
| [overview.md](./overview.md)                         | Entornos, secretos, observabilidad y enlaces |
| [production-checklist.md](./production-checklist.md) | Checklist para llevar el MVP a producción    |
| [supabase-auth-setup.md](./supabase-auth-setup.md)   | Supabase Auth con GitHub OAuth               |
| [github-app-setup.md](./github-app-setup.md)         | GitHub App para sincronización de repos      |
| [email-setup.md](./email-setup.md)                   | Invitaciones por email con Resend (opcional) |
| [packaging-limits.md](./packaging-limits.md)         | Límites suaves gratuitos por organización    |
